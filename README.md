...
I am an undergraduate student, and in my free time I like to carry out different machine learning studies on medical datasets. In 2020 this little side passion of mine became part of my career as a medical researcher when I performed a cardiovascular disease clustering study with an accompanying paper written in LaTeX. Since then I have won the Santander Universities Global Challenges COVID-19 Research Scholarship involving the diagnosis of COVID-19 using smartphone recorded coughs, using a novel algorithm to segment the audio samples and perform conformal prediction on the dataset. My study is currently being published and will be available in the coming months. I will also be attending the conference CoPA 2022: The 11th Symposium on Conformal and Probabilistic Prediction with Applications.

I am looking to perform more machine learning and deep learning studies focusing on the diagnosis and prognosis of disease, specifically pulmonary diseases such as lung cancers and pneumonia, but I have also taken an interest in cardiovascular diseases. I specialise mostly in the use of numerical and audio datasets, but lately I have taken an interest in radiology and image datasets. I am particularly interested in classification and regression using neural networks - Artificial Neural Networks (ANN), Convolutional Neural Networks (CNN) and Recurrent Neural Networks (RNN) - as well as Multi-Layer Perceptrons (MLP), Decision Trees (DT), and Support Vector Machines (SVM). I'd like to investigate Generative Adversarial Networks (GAN) as well but that's more for the sake of curiousity. I'm also interested in clustering studies using K-Means and K-Modes, and lastly ensemble classification using Random Forests (RF), bagging, stacking, and voting classifiers.

I am also looking to perform more conformal prediction studies for both classification and regression, particularly in Inductive Conformal Prediction (ICP), Mondrian Inductive Conformal Prediction (MICP), and Mondrian Cross-Conformal Prediction (MCCP). In addition, I am interested in researching the class imbalance problem, different evaluation metrics for imbalanced datasets, undersampling and oversampling techniques (and SMOTE), cost-sensitive learning, and classification boosting. Lastly, I would like to work on a few multiclass and one-class classification studies, as both are useful for rare disease diagnosis, such as a rare genetic disease.
